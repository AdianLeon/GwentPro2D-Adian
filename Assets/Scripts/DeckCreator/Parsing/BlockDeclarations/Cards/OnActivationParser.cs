...
public partial class Parser
{
    ...
    {
        if (!File.Exists(Application.persistentDataPath + "/CreatedEffects/" + effectName + ".txt")) { Errors.Write("El efecto '" + effectName + "' no existe en la base de datos", Current); hasFailed = true; return null; }
        string effectCode = File.ReadAllText(Application.persistentDataPath + "/CreatedEffects/" + effectName + ".txt");
