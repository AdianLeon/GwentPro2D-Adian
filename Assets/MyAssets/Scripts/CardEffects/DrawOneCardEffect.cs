...
public class DrawOneCardEffect : CardEffect
{
    override public void TriggerEffect(){//Roba una carta del deck propio
        ...
        if(this.GetComponent<Dragging>().whichField==Dragging.fields.P1){//Si la Scarlett Overkill jugada es de P1
            PlayerArea=GameObject.Find("Hand");
            PlayerDeck=GameObject.Find("Deck");
        }else if(this.GetComponent<Dragging>().whichField==Dragging.fields.P2){//Si la Scarlett Overkill jugada es de P2
