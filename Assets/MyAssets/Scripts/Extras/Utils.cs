...
{
    public static int FindMatchingParenthesis(List<CustomClasses.Token> tokenList,int pos){//Dado un parentesis de apertura halla su respectivo parentesis de clausura
        List<CustomClasses.Token> aux=new List<CustomClasses.Token>();
