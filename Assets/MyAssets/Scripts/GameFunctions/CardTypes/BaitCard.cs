...
public class BaitCard : PowerCard, ISpecialCard, IAffectable
{
    ...
    private bool SwapConditions(DraggableCard cardToSwap, bool showMessage = false)
    {//Si no es una carta lider, no esta en la mano ni en el cementerio, coincide con el campo del senuelo, no es otro senuelo y es afectable
