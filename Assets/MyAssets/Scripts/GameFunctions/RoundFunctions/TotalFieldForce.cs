...
{
    private static int p1ForceValue;//Total de poder de cada jugador en la ronda
    public static int GetP1ForceValue{get=>p1ForceValue;}
    private static int p2ForceValue;
    public static int GetP2ForceValue{get=>p2ForceValue;}
